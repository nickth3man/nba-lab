...
const createMockEdge = (id: string, source: string, target: string, overrides: Partial<EdgeData> = {}): EdgeData => ({
  id,
  source,
  target,
  weight: 1,
...
describe('PlayerTooltip Component', () => {
  ...
  describe('Top 5 Teammates', () => {
    it('renders up to 5 teammates sorted by duration', () => {
      ...
      const edges: EdgeData[] = [
        createMockEdge('e1', '1', '2', {
          teams: [{ team_id: 'CHI', team_name: 'Chicago Bulls', team_abbreviation: 'CHI', seasons: ['1990-91', '1991-92'], overlap_days: 730 }],
          total_days: 730,
        }),
        createMockEdge('e2', '1', '3', {
          teams: [{ team_id: 'CHI', team_name: 'Chicago Bulls', team_abbreviation: 'CHI', seasons: ['1989-90'], overlap_days: 365 }],
          total_days: 365,
        }),
        createMockEdge('e3', '1', '4', {
          teams: [{ team_id: 'CHI', team_name: 'Chicago Bulls', team_abbreviation: 'CHI', seasons: ['1995-96'], overlap_days: 365 }],
          total_days: 365,
        }),
        createMockEdge('e4', '1', '5', {
          teams: [{ team_id: 'CHI', team_name: 'Chicago Bulls', team_abbreviation: 'CHI', seasons: ['1987-88'], overlap_days: 365 }],
          total_days: 365,
        }),
        createMockEdge('e5', '1', '6', {
          teams: [{ team_id: 'CHI', team_name: 'Chicago Bulls', team_abbreviation: 'CHI', seasons: ['1971-72'], overlap_days: 365 }],
          total_days: 365,
        }),
        createMockEdge('e6', '1', '7', {
          teams: [{ team_id: 'CHI', team_name: 'Chicago Bulls', team_abbreviation: 'CHI', seasons: ['1966-67'], overlap_days: 365 }],
          total_days: 365,
        }),
      ];
    ...
    it('sorts teammates by total overlap days descending', () => {
      ...
      const edges: EdgeData[] = [
        createMockEdge('e1', '1', '2', {
          teams: [{ team_id: 'T1', team_name: 'Team A', team_abbreviation: 'T1', seasons: ['2020-21'], overlap_days: 100 }],
          total_days: 100,
        }),
        createMockEdge('e2', '1', '3', {
          teams: [{ team_id: 'T2', team_name: 'Team B', team_abbreviation: 'T2', seasons: ['2010-11', '2011-12', '2012-13', '2013-14'], overlap_days: 1460 }],
          total_days: 1460,
        }),
      ];
  ...
  describe('Edge Cases', () => {
    it('handles player with multiple teams on one edge', () => {
      ...
      const edges: EdgeData[] = [
        createMockEdge('e1', '1', '2', {
          teams: [
            { team_id: 'LAL', team_name: 'Los Angeles Lakers', team_abbreviation: 'LAL', seasons: ['1996-97', '1997-98', '1998-99', '1999-00'], overlap_days: 1461 },
            { team_id: 'MIA', team_name: 'Miami Heat', team_abbreviation: 'MIA', seasons: ['2004-05'], overlap_days: 365 },
          ],
          total_days: 1826,
        }),
      ];
    ...
    it('handles teammate with empty seasons array', () => {
      ...
      const edges: EdgeData[] = [
        createMockEdge('e1', '1', '2', {
          teams: [{ team_id: 'T1', team_name: 'Team', team_abbreviation: 'T1', seasons: [], overlap_days: 0 }],
          total_days: 0,
        }),
      ];
