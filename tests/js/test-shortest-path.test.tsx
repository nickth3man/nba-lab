...
describe("ShortestPath Component", () => {
  ...
  it("finds and displays path between two players", async () => {
    ...
    expect(mockOnPathChange).toHaveBeenCalledWith(["player1", "player2", "player3", "player4"]);
  });
